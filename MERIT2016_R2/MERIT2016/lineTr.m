%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% lineTr.m
%% MatLAB program - Symmetrical networks for three transmission line
%% Full Transposed Line
...
%Section #3 - line ABC.
Z3abc=Zabc*s3;  Z3abc=R^(-1)*Z3abc*R;    
...
FileName = 'outputTransp.txt';
fOut = fopen(FileName,'w');
 fprintf(fOut,'OUTPUT <TRANSPOSED> FILE\n\n');
 fprintf(fOut,'------------------------------------------------\n');
 ...
 fprintf(fOut,'\n\n---------------------------------------------------------------\n');
 fprintf(fOut,'Total impedance of line (ABC):\n');
 ...
 fprintf(fOut,'\n\n---------------------------------------------------------------\n');
 fprintf(fOut,'Sequence impedances of line (012):\n');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lineTran;  %go to PowerLib model and start simulation
