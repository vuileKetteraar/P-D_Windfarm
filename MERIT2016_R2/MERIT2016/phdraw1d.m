...
if Bactive==1,
   ...
   Htitm=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[0 .10 .12 0.04],'string','Mag.');
   Htit(a,1)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.10 .14 .12 0.04],'string','Phase a');
   H_mag(a,1)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.10 .10 .12 0.04],'background',[1 1 1]);
   Htit(a,2)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.236 .14 .12 0.04],'string','Phase b');
   H_mag(a,2)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.236 .10 .12 0.04],'background',[1 1 1]);
   Htit(a,3)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.372 .14 .12 0.04],'string','Phase c');
   H_mag(a,3)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.372 .10 .12 0.04],'background',[1 1 1]);
   Htit(a,4)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.508 .14 .12 0.04],'string','Zero');  
   H_mag(a,4)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.508 .10 .12 0.04],'background',[1 1 1]);
   Htit(a,5)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.644 .14 .12 0.04],'string','Positive');
   H_mag(a,5)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.644 .10 .12 0.04],'background',[1 1 1]);
   Htit(a,6)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.78 .14 .12 0.04],'string','Negative');
   H_mag(a,6)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.78 .10 .12 0.04],'background',[1 1 1]);
   Htita=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.0 .05 .12 0.04],'string','Phase');
   H_ang(a,1)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.10 .05 .12 0.04],'background',[1 1 1]);
   H_ang(a,2)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.236 .05 .12 0.04],'background',[1 1 1]);
   H_ang(a,3)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.372 .05 .12 0.04],'background',[1 1 1]);
   H_ang(a,4)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.508 .05 .12 0.04],'background',[1 1 1]);
   H_ang(a,5)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
      'posi',[.644 .05 .12 0.04],'background',[1 1 1]);
   H_ang(a,6)=uicontrol(gcf,'fontsize',1,'style','text','units','normalized',...
